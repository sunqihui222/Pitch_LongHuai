...
import com.shtoone.liqing.mvp.presenter.WaterStability.MaterialStatisticsPresenter;
...
public class MaterialStatisticsFragment extends BaseFragment<MaterialStatisticsContract.Presenter> implements MaterialStatisticsContract.View {
    ...
    private MaterialStatisticsData data;
    private MaterialStatisticsRecycleViewAdapter mMsAdapter;
    ...
    @NonNull
    @Override
    protected MaterialStatisticsContract.Presenter createPresenter() {
        return new MaterialStatisticsPresenter(this);
    }

    public static MaterialStatisticsFragment newInstance(DepartmentBean departmentBean) {

        MaterialStatisticsFragment fragment = new MaterialStatisticsFragment();
    ...
    private void initData() {
        ...
        if (null != BaseApplication.parametersData) {
            ...
            mParametersData.fromTo = Constants.MaterialStatisticsFragment;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                KLog.e(TAG, mParametersData.toString());
                mParametersData.getTo = Constants.MaterialStatisticsFragment;
                mParametersData.departType = mDepartmentBean.departtype;
                mParametersData.biaoshiid = mDepartmentBean.departmentID;
                mParametersData.deviceType = Constants.TYPE_WATERSTABILITY;
                ((WaterStabilityActivity) _mActivity).startDrawerActivity(mParametersData, null);
            }
        });
        ...
        mMsAdapter = new MaterialStatisticsRecycleViewAdapter();
...
//        if (null != toolbarToolbar && null != BaseApplication.mDepartmentData && !TextUtils.isEmpty(BaseApplication.mDepartmentData.departmentName)) {
        ...
        sb.append(getString(R.string.matrial_Stastics));
...
//                        KLog.e(TAG,mDepartmentBean.toString());
                        BaseApplication.mDepartmentData.fromto = Constants.MaterialStatisticsFragment;
    ...
    public void updateDepartment(EventData eventData) {
        ...
        if (null != eventData.departmentData && null != this.mDepartmentBean) {
            if (eventData.departmentData.fromto == Constants.MaterialStatisticsFragment) {
