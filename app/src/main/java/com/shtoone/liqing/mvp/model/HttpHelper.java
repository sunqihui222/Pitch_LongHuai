...
//            builder.cache(cache);
            //设置超时
            builder.connectTimeout(Constants.INTERNET_TIMEOUT, TimeUnit.SECONDS);
            builder.readTimeout(Constants.INTERNET_TIMEOUT, TimeUnit.SECONDS);
            builder.writeTimeout(Constants.INTERNET_TIMEOUT, TimeUnit.SECONDS);
            //错误重连
