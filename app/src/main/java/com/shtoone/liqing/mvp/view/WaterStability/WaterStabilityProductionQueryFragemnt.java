...
import com.shtoone.liqing.mvp.presenter.WaterStability.ProductionDataQueryPresenter;
import com.shtoone.liqing.mvp.view.adapter.OnItemClickListener;
import com.shtoone.liqing.mvp.view.adapter.WaterStabilityProductionqueryFragmentAdapter;
...
public class WaterStabilityProductionQueryFragemnt extends BaseFragment<ProductionDataQueryContract.Presenter> implements ProductionDataQueryContract.View {
    ...
    private WaterStabilityProductionqueryFragmentAdapter madapter;
    ...
    public static WaterStabilityProductionQueryFragemnt newInstance(DepartmentBean departmentBean) {
        ...
        WaterStabilityProductionQueryFragemnt fragment = new WaterStabilityProductionQueryFragemnt();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_productionquery_waterstability, container, false);
    ...
    private void initDate() {
        ...
        parametersData.fromTo = Constants.WATERSTABILITYPRODUCTIONQUERYFRAGMENT;
        departmentBean.fromto = Constants.WATERSTABILITYPRODUCTIONQUERYFRAGMENT;
        ...
        madapter = new WaterStabilityProductionqueryFragmentAdapter();
...
//                }
        ...
        madapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                departmentBean.userpositon=madapter.getData().get(position).getUsePosition();
...
//        }
    ...
    @Override
    public void responseProductionDataQueryBean(WaterstabilityHistoryData productionDataQueryBean) {

        isLoading = false;
        parametersData.currentPage = 1;
        list = productionDataQueryBean.getData();
        madapter.removeAllHeaderView();
        madapter.removeAllFooterView();
        madapter.setOverProofData(productionDataQueryBean);
        madapter.notifyDataSetChanged();
    ...
    public void updateDepartment(EventData eventData) {
        ...
        if (eventData.parametersBean != null && null != this.parametersData) {
            if (eventData.parametersBean.fromTo == Constants.WATERSTABILITYPRODUCTIONQUERYFRAGMENT) {
                ...
                this.parametersData.userposition = eventData.parametersBean.userposition;
    ...
    @NonNull
    @Override
    protected ProductionDataQueryContract.Presenter createPresenter() {
        return new ProductionDataQueryPresenter(this);
    }
